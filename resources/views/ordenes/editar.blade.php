<div class="card">
    <form action="{{ route('ordenes.oupdate', $ordenes) }}" method="POST">
        @csrf
        <div class="card-header">
            <div class="row">
                <div class="col-12">
                    <h4>
                        <i class="fas fa-id-card"></i> Datos de la Orden              
                    </h4>
                </div>                
              </div>           
        </div>
        ...
        <div class="card-footer">
            {{-- <button type="submit" class="btn btn-file btn-success btn-flat pull-right fa fa-save float-right"> Editar</button> --}}
